import{i as w,a as v,s as x,p as b}from"./theme-DoTs2NV7.js";const o=document.getElementById("themeToggle"),E=w();o&&(o.textContent=E==="light"?"🌛":"🌞",o.addEventListener("click",()=>{const t=document.documentElement.getAttribute("data-theme")==="light"?"🌛":"light";v(t),x(t),o.textContent=t==="light"?"🌛":"🌞"}));document.getElementById("year").textContent=new Date().getFullYear();const M=document.getElementById("projectsGrid"),$=e=>[...e].sort((t,s)=>new Date(s.date)-new Date(t.date)),k=e=>{M.innerHTML=e.map(t=>{const s=t.demoUrl&&t.demoUrl!=="#"?`<a class="btn" href="${t.demoUrl}" target="_blank" rel="noreferrer">Ver Demo</a>`:"",y=t.repoUrl&&t.repoUrl!=="#"?`<a class="btn" href="${t.repoUrl}" target="_blank" rel="noreferrer">Ver en GitHub</a>`:"";return`
