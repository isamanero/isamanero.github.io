import{i as f,a as y,s as p,p as v}from"./theme-CFEcXcHg.js";const r=document.getElementById("themeToggle"),w=f();r&&(r.textContent=w==="light"?"🌛":"🌞",r.addEventListener("click",()=>{const t=document.documentElement.getAttribute("data-theme")==="light"?"🌛":"light";y(t),p(t),r.textContent=t==="light"?"🌛":"🌞"}));document.getElementById("year").textContent=new Date().getFullYear();const x=document.getElementById("projectsGrid"),b=e=>[...e].sort((t,l)=>new Date(l.date)-new Date(t.date)),E=e=>{x.innerHTML=e.map(t=>{const l=t.demoUrl&&t.demoUrl!=="#"?`<a class="btn" href="${t.demoUrl}" target="_blank" rel="noreferrer">Ver Demo</a>`:"",g=t.repoUrl&&t.repoUrl!=="#"?`<a class="btn" href="${t.repoUrl}" target="_blank" rel="noreferrer">Ver en GitHub</a>`:"";return`
